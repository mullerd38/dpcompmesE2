...
var welcome = {
  ...
  stimulus:
    ...
    "<p class='instructions'>TEST9 Thank you for taking part in this survey. <b> Please note that you can only participate from a computer.</b> </p>" +
...
var slider = {
  ...
  on_load: function() {
    ...
    // Ensure the answer is hidden until interaction
    display.style.visibility = "hidden"; 

    slider.addEventListener("input", function() {
      display.innerText = slider.value;  // Update displayed value
